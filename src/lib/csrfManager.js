 ...
 *    along with your www.my-bank.com cookie and it will look perfectly legitimate. There goes your money!
 *
 ...
 * 2- That token is a huge, impossible-to-guess random number that my-bank.com will include on their own web
 ...
 *    surrender it (if the browser works correctly...), and so the attacker will not be able to create
 *    a valid request, because requests with the wrong token (or no token) will be refused by www.my-bank.com.
 */
